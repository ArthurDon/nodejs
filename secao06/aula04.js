...
function imprime_valores(num1, num2){
    for(let i in arguments){
        console.log(arguments[i]) // Arguments foi fundamental, nao usamos o num1, num2
    }
}
...
// imprime_valores(3, 6, 8, 65, 32, 12);

// Gambiarra 1 sobre valor padrão
...
//console.log(somar2(0, 0, 0))//6 (bug na gambiarra, era pra ser 0)
...
// console.log(somar4(true, false, 'c'))// 1c (1 é true e false é 0)
// console.log(somar4(2, true, false))// 3 (2 + true que é 1)


/*
Em JavaScript, 1 é considerado true e 0 false
*/
...
console.log(somar5(true, false, 'c'))// 1c (1 é true e false é 0)
console.log(somar5(2, true, false))// 3 (2 + true que é 1)